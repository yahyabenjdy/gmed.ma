...
const PaymentsToolbar = ({
  ...
  // Helper Component with DYNAMIC WIDTH calculation (Same logic as Registrations)
  const CustomSelect = ({
    icon: Icon,
    value,
    onChange,
    ...
    const dynamicWidth = Math.max(110, currentLabel.length * 9 + 60);
    ...
    <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex flex-col xl:flex-row items-center gap-3 animate-fade-in mb-6">
      ...
      <div className="flex gap-2 ml-auto flex-shrink-0">
        ...
        <button
          ...
          className="bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg font-bold flex items-center gap-2 shadow-md shadow-green-600/20 transition-all active:scale-95 text-sm"
        >
