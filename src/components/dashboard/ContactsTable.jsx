      ...
      <table className="w-full text-left border-collapse border border-slate-200">
        <thead className="bg-slate-50 text-slate-600 text-xs uppercase tracking-wider sticky top-0 z-10 shadow-sm border-b border-slate-200">
          <tr className="divide-x divide-slate-200">
            ...
            <th className="p-4">Détails (Tel/Email)</th>
        ...
        <tbody className="divide-y divide-slate-100">
          {data.map((msg) => (
            ...
            >
              <td className="p-4 font-bold text-slate-700 align-top">
                {msg.name}
              </td>
              <td className="p-4 text-sm align-top space-y-1">
                <div className="font-bold text-slate-700 font-mono">
                  {msg.phone || "--"}
                </div>
                <div className="text-slate-500">{msg.email}</div>
              </td>
              <td className="p-4 text-slate-600 text-sm leading-relaxed align-top">
              ...
              <td className="p-4 text-slate-400 text-xs align-top font-medium">
